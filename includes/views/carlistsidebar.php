<div class="middle_two_right_announces">
	...
	<?php  if(strpos($_SERVER['REQUEST_URI'],'nosstock')==false) $activeBanner = false;
		else if(strpos($_SERVER['REQUEST_URI'],'announces')==false) $activeBanner = false;
		else $activeBanner = true;
		?>
	<?php if( $activeBanner ) { ?>
