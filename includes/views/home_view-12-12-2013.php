              ...
              <div class="price_box">
                ...
                <div class="price_slider">
                 <span style="display: inline-block; width: 130px;">
                    <input id="Slider1" type="slider" name="price" value="0;100000" />
                </span>
                </div>               
    ...
    <div class="remind_box">
      ...
      <div class="remind_inner">
        ...
        <form>
            ...
            <input type="text" class="remind_textbox" name="email" id="newletter_email_top">
          <input type="submit" class="remind_submit" onclick="return submitAjaxFormTop();">
        </form>
      </div>
    </div>
  </div>
...
<!--middle end-->
 ...
 function submitPhoneLead(){
     ...
     if(phone==""){
         ...
         alert("S'il vous plaît entrer le numéro que");
         return false;
     }else{
        $.ajax({
               type: "POST",
             ...
             success: function(data) {  
                   if(type=="append"){
                        $.each(data, function(i){                                
                                $('#model_select').append('<option value="'+data[i]['value']+'">'+data[i]['value']+'</option>');                                
                        });
                   }else{
                       $.each(data, function(i){                         
