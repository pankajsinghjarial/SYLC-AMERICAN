            ...
            <div class="first-part">
                <div class="block-one-of-first-part">
                    <h4 class="Buick-Riviera  blue-gradient">
                       <?php echo $temp[$carid]["fullName"]; if($temp[$carid]["price"] != "") {
                         echo  " - $".number_format($temp[$carid]["price"],2) ;
                        } ?>
                    </h4>
                    ...
                    <div class="stock-ul">
                        ...
                        <p class="blue-tyext" style="width: 165px;">
                            ...
                            ?>
                            <img src="<?php 
									echo DEFAULT_URL."/toImage.php?vin=".encrypt($temp[$carid]["vin"],"b8903a94bdd93013c74f178f194c460b");
									?>">
                        </p>
                    </div>
                    <?php }?>
                    ...
                    <div class="stock-ul">
                        ...
                        <p class="blue-tyext">
                           <?php echo $common->CurrencyConverter($temp[$carid]["price"]);?> &euro;
                        </p>
                    </div>
                     <?php }?>
                </div>
                ...
                <div class="block-one-of-first-part">
                    ...
                    <?php
                        $spec = explode(",",$temp[$carid]["features"]); 
                       
//                        foreach($spec as $spex)
//                        {
//                            $spexs = explode(",",$temp[$carid]["features"]); 
...
//                        }
                    ...
                    <?php $i=0; foreach($spec as $key=> $val){?>
                                <div class="stock-ul<?php if($i%2==0){ echo "4";}else{ echo "5";} ?>">
                                    <p class="blue-tyext3"><?php echo $val; ?></p>
                                </div>
                    <?php  $i++; }  ?>
			...
			} else
			{
	   		...
	   		?>
                               <li> <a href="#" rel="p<?=$i?>">   <img src="<?php echo DEFAULT_URL; ?>/image_resizer.php?img=<?php echo urlencode($imgpath); ?>&newWidth=80&newHeight=60" alt="<?php echo $f_read->title;?>"/></a></li>
                         <?php }?> 
                        </ul>
                    </div>
                ...
                <div class="descri-part">
                    ...
                    <div class="descript-div-para2">
                        <div class="descript-div-para">
							...
							<li style="width: 250px; margin: 5px 15px 0 5px;"><strong>Engine:</strong>
								<?php echo $temp[$carid]["engine"]?></li>
							<?php } ?>
							<?php if($temp[$carid]["extColor"]!= "" ) { ?>
							<li style="width: 250px; margin: 5px 15px 0 5px;"><strong>Exterior
									Color:</strong> <?php echo $temp[$carid]["extColor"]?></li>
							<?php } ?>
							<?php if($temp[$carid]["interColor"]!= "" ) { ?>
							<li style="width: 250px; margin: 5px 15px 0 5px;"><strong>Interior
									Color:</strong> <?php echo $temp[$carid]["interColor"]?></li>
							<?php } ?>
							<?php if($temp[$carid]["transmission"]!= "" ) { ?>
							<li style="width: 250px; margin: 5px 15px 0 5px;"><strong>Transmission:</strong>
								<?php echo $temp[$carid]["transmission"]?></li>
							<?php } ?>
							<?php if($temp[$carid]["drivetrain"]!= "" ) { ?>
							<li style="width: 250px; margin: 5px 15px 0 5px;"><strong>Drive
									Train:</strong> <?php echo $temp[$carid]["drivetrain"]?></li>
							<?php } ?>
							<?php if($temp[$carid]["doors"]!= "" ) { ?>
							<li style="width: 250px; margin: 5px 15px 0 5px;"><strong>Doors:</strong>
								<?php echo $temp[$carid]["doors"]?></li>
							<?php } ?>
							<?php if($temp[$carid]["wheelbase"]!= "" ) { ?>
							<li style="width: 250px; margin: 5px 15px 0 5px;"><strong>Wheel
									Base:</strong> <?php echo $temp[$carid]["wheelbase"]?></li>
							<?php } ?>
						</ul>
                            </p>
                        </div>
        ...
        <!-- AddThis Button END -->
            ...
            <div class="third-part">
                <div class="block-one-of-first-part">
                    ...
                    <h3 class="StockID2">Ce voitures du marché de détail 
                        courant valeur est estimée</h3>
<!--                    <div class="stock-ul">
           ...
           <div class="block-one-of-first-part233">
                    ...
                    <div class="tree-vew-div"><div class="packceo-red technology">Pack ECO</div><div class="black-text-of-red">19,208.66 &euro;</div></div>
                    ...
                    <div class="tree-vew-div"><div class="packceo-red technology">Pack Expert</div><div class="black-text-of-red">22,686.00 &euro;</div></div>
                    <div class="hidden-div-red2 thelanguage">
                        <ul class="hidden-list">
                            <li>1. Validation du vendeur</li>
                    ...
                    <div class="tree-vew-div"><div class="packceo-red technology" style="width: 176px;">Pack a La Carte</div>
