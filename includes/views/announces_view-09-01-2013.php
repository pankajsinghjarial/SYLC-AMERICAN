							...
							<table width="100%" border="0">
								...
								jQuery.ajax({
								  ...
								  if($madeYear[1] == $i){
									...
									<?php  if(empty($_REQUEST['price']) && !empty($_SERVER['mysearch'][0]['price']) ) $_REQUEST['price']  =  $_SERVER['mysearch'][0]['price'];
									...
									<input id="Slider1" type="slider" name="price" value="<?php echo $minPrice.';'.$maxPrice; ?>" />
								    </span>
