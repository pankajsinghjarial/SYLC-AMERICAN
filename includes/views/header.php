  ...
  <div class="header">
    ...
    <div class="nav nav_inner">
      <ul>
        ...
        <li><a <?php if(basename(array_shift(explode('?', $_SERVER['REQUEST_URI'])))=='services') { ?> class="active" <?php } ?>  href="<?php echo DEFAULT_URL; ?>/<?php echo $commons->getPageSlug('52'); ?>"><span>Services</span></a>
            <ul>
        ...
        <li><a <?php if(basename(array_shift(explode('?', $_SERVER['REQUEST_URI'])))=='presentation') { ?> class="active" <?php } ?> href="<?php echo DEFAULT_URL; ?>/<?php echo $commons->getPageSlug('53'); ?>"><span>Presentation</span></a></li>
