		    ...
		    <?php echo $item->title;?></h4>
                    ...
                    <div class="stock-ul">
                        ...
                        <p class="blue-tyext" style="width: 175px;">
                            <img src="<?php echo DEFAULT_URL."/toImage.php?vin=".encrypt($item->vin,"je=.8)#?9S*mFN%");?>">
                        </p>
                    </div>
                    <?php }?>
                     <?php 
...
font: 400 19px 'Cabin', serif;
                ...
                <div class="descri-part">
                    ...
                    <div class="descript-div-para2">
                        <div class="descript-div-para" id="ebay_desc" style="width: auto; padding: 0px;">
                            <iframe src="<?php echo DEFAULT_URL?>/includes/code/ajax_ebay_desc.php" width="482" height="400" scroll="no" style="border: none;">
                            </iframe>
                        </div>
                    </div>
                </div>
...
<!--                    <div class="stock-ul">
			...
			if($item->buyItNowPrice > 0 && trim(strtolower($item->listingType)) == "auction"){ ?>
                    ...
                    <div class="tree-vew-div">
                        ...
                        <?php if($item->buyItNowPrice > 0 && trim(strtolower($item->listingType)) == "auction"){  ?>
                        <div class="black-text-of-red">
                            <?php 
		...
		?>
                ...
                <!--block 3 end-->
                <a class="newpage_link" href="<?php echo DEFAULT_URL;?>/newpage.php?carid=<?php echo $_GET['carid'];?>"></a>
            </div> 
            <!--three part end-->   
