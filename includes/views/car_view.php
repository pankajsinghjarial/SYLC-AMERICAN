                        ...
                        function wishlistcar(carid,cartype,carname,carimg,carprice){
                                ...
                                $.ajax({
                                        ...
                                        success: function(data) {
                                              alert("Car hass &eacute;t&eacute; ajout&eacute; &agrave; votre s&eacute;lection");
                                              $(divname).html("");
                                              $(divname).append(data);
                                        }
                                });
...
<!--                    <a href="#" class="button-reche"></a>-->
        ...
        <!--recharche end-->  
		<?php $carInfo = $temp[$carid];
		$price = (float)number_format($carInfo['price'],2,'.','');
        ...
        <div class="three-parts">
            <div class="first-part">
                <div class="block-one-of-first-part">
                    <h4 class="Buick-Riviera  blue-gradient">
                       <?php echo $temp[$carid]["fullName"];  ?>
                    </h4>
                    ...
                    <div class="stock-ul">
                        ...
                        <p class="blue-tyext" style="width: 165px;">
                            <?php 
						...
						return trim($data); 
                            ...
                            ?>
			    <img src="<?php echo DEFAULT_URL."/toImage.php?vin=".encrypt($temp[$carid]["vin"],"je=.8)#?9S*mFN%");?>">
                    ...
                    <div class="stock-ul2">
                        <p class="vin-text">Mileage</p><p class="vin-text2">Mi</p><p class="blue-tyext2"><?php echo number_format($temp[$carid]["mileage"],2);?></p>
                    </div>
                     <?php }?>
                    ...
                    <div class="stock-ul">
                        ...
                        <p class="blue-tyext">
                           <?php echo $ori_price = $common->CurrencyConverter($price);?> &euro;
                        </p>
                    </div>
                     <?php }?>
                </div>
                ...
                <div class="block-one-of-first-part">
					...
					$carFeaturesList = array(
											 ...
											 'interColor' => 'Interior Color',
											 'number_cylinders' => 'Number of Cylinders',
											 'transmission' => 'Transmission',
											 'bodyStyle' => 'Body Type',
											 'cab_type_trucks' => 'Cab type (For Trucks Only)',
											 'cab_type' => 'Cab type',
											 'warranty' => 'Warranty',
                    ...
                    <?php $i=0; foreach($carFeaturesList as $feature => $value ) {
						
								if( !empty( $carInfo[$feature] ) ) { ?>
					
                                <div class="stock-ul<?php if($i%2==0){ echo "4";}else{ echo "5";} ?>">
                                    <p class="vin-text3"><?php echo $value; ?>:</p><p class="blue-tyext3">
									
									<?php echo ($feature == 'mileage' ) ? number_format($carInfo[$feature]) : $carInfo[$feature]; ?></p>
                    ...
                    <div class="commander">
                        ...
                        <a href="<?php echo DEFAULT_URL; ?>/add_to_inquiry.php?carId=<?php echo $carid;?>&order=true" class="command-button example5"></a>
                    </div>
			...
			if($temp[$carid]["images"] != "") {
                            ...
                            $imgpath = str_replace("preview", "supersized", $imgpath);
			} else
			{
			...
			?>
                    <div class="big-image-slide" id="slideshow-main">
                        <ul>
                            <li class="pa active">
                                <a href="#">
									<!--<img src="<?php echo $imgpath; ?>" alt="" width="443" />-->
									<img class="pa active" src="<?php echo DEFAULT_URL; ?>/image_resizer.php?img=<?php echo urlencode($imgpath); ?>&newWidth=443&newHeight=331" alt="<?php echo $f_read->title;?>"/>
								</a>
				...
				for($i=1;$i<$count;$i++) {
	   		    ...
	   		    ?>
                            <li class="p<?=$i?>">
                                <a href="#">
									<img src="<?php echo DEFAULT_URL; ?>/image_resizer.php?img=<?php echo urlencode($imgpath); ?>&newWidth=443&newHeight=331" alt="" />
                                </a>
                            </li>
                            <?php }  } ?>
                        </ul>
                     ...
                     <div id="slideshow-carousel" class="thumb-opart jcarousel jcarousel-skin-tango">
                        <ul id="carousel" class="jcarousel jcarousel-skin-tango">
                            ...
                            ?>
                            <li> <a href="#" rel="pa">
							<img  src="<?php echo DEFAULT_URL; ?>/image_resizer.php?img=<?php echo urlencode($imgpath); ?>&newWidth=80&newHeight=80" alt="<?php echo $f_read->title;?>"/>
	   		...
	   		?>
                               <li> <a href="#" rel="p<?=$i?>">
							   <img src="<?php echo DEFAULT_URL; ?>/image_resizer.php?img=<?php echo urlencode($imgpath); ?>&newWidth=80&newHeight=60" alt="<?php echo $f_read->title;?>"/>
							   </a></li>
                         <?php }?> 
                        </ul>
                    </div>
...
font: 400 19px 'Cabin', serif;
                    ...
                    <div class="four-buttons">
                        ...
                        <div class="one-button-row">
                            ...
                            <?php }else{?>
                            <a href="javascript:void(0);" onclick="wishlistcar('<?php echo $carid;?>','local','<?php echo $temp[$carid]["fullName"];?>','<?php echo $gallery[0];?>','<?php echo $temp[$carid]["price"]; ?>')" class="button-on3"></a>
                                <?php } }else{?>
                ...
                <div class="contact-box-part">
                    ...
                    <span class="ct-number">01.60.29.99.02 <br/>06.98.22.51.82</span>
                </div>
                <!--contact end-->
                ...
                <div class="descri-part">
                    ...
                    <div class="descript-div-para2">
                        <div class="descript-div-para">
                            <p>
                            <?php
							if(!empty($temp[$carid]["description"])) {
							 echo $temp[$carid]["description"];  } ?>
                            </p>
                        </div>
                    </div>
                </div>
        ...
        <!-- AddThis Button END -->
                    ...
                    <div class="three-liand-button">
                        <ul class="left-li-three">
                            ...
                            <?php if(isset($_SESSION['User']['id']) && $_SESSION['User']['id']>0){ ?>
                                <li><a href="javascript:void(0);" onclick="wishlistcar('<?php echo $carid;?>','local','<?php echo $temp[$carid]["fullName"];?>','<?php echo $gallery[0];?>','<?php echo $temp[$carid]["price"]; ?>')">Ajouter &agrave; ma sélection</a></li>
                                <li><a href="javascript:void(0);" onclick="wishlistcar('<?php echo $carid;?>','local','<?php echo $temp[$carid]["fullName"];?>','<?php echo $gallery[0];?>','<?php echo $temp[$carid]["price"]; ?>')">Sauvegarder cette annonce</a></li>
                            <?php }else{?>
            ...
            <div class="third-part">
                <div class="block-one-of-first-part">
                    ...
                    <h3 class="StockID2"><!--Voici la valeur estimative actuelle de cette voiture sur le marché-->
					<a href="http://www.kbb.com/" target="_blank" style="text-decoration: underline">Clickez ici</a>  pour voir  la valeur estimative actuelle de cette voiture sur le marché
					<a href="http://www.kbb.com/"  target="_blank"><img src="<?php echo DEFAULT_URL; ?>/images/Kelley-Blue-Book.jpg" width='220' ></a>
		...
		<!--                    <div class="stock-ul">
           ...
           <div class="block-one-of-first-part233">
                    ...
                    <div class="tree-vew-div">
						<div class="packceo-red technology">Pack ECO</div>
						<div class="black-text-of-red">
							<?php 
                                $eco_prize = $price+5600.00;
                ...
                <!--block 3 start-->
                        ...
                        <div class="etape_nav10">
                            <ul id="sidebar_nav">
                                <li class="active_nav">
                                    <div class="mypets">
                                        <div class="nav_content">Jusqu'à 40% d'économie</div>
                                    </div>
                                    <div class="hidden-div-red233 thepet">
                                        <p class="hiddenpara">Jusqu'à 40% d'économie<br></p>   
                                    </div>
                                </li>

                                <li>
                                    <div class="mypets">
                                        <div class="nav_content douleline">L'exportateur le plus réactif du marché</div>
                                    </div>
                                    <div class="hidden-div-red233 thepet">
                                        <p class="hiddenpara">L'exportateur le plus réactif du marché<br></p>   
                                    </div>
                                </li>

                                <li>
                                    <div class="mypets">
                                        <div class="nav_content">97.4% de clients satisfaits<br/></div>
                                    </div>
                                    <div class="hidden-div-red233 thepet">
                                        <p class="hiddenpara">97.4% de clients satisfaits</p>   
                                    </div>
                                </li>

                                <li>
                                    <div class="mypets">
                                        <div class="nav_contentdouleline23">Un interlocuteur aux US et en France<br>
                                            </div>
                                    </div>
                                    <div class="hidden-div-red233 thepet">
                                        <p class="hiddenpara">Un interlocuteur aux US et en France<br></p>   
                                    </div>
                                </li>
				
				 <li>
                                    <div class="mypets">
                                        <div class="nav_contentdouleline23">Fonds sécurisés et garantis par Bank Of America<br>
                                            </div>
                                    </div>
                                    <div class="hidden-div-red233 thepet">
                                        <p class="hiddenpara">Fonds sécurisés et garantis par Bank Of America<br></p>   
                                    </div>
                                </li>
				 
				 <li>
                                    <div class="mypets">
                                        <div class="nav_contentdouleline23">Tarifs logistique imbattables<br>
                                            </div>
                                    </div>
                                    <div class="hidden-div-red233 thepet">
                                        <p class="hiddenpara">Tarifs logistique imbattables<br></p>   
                                    </div>
                                </li>
