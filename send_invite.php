...
<div class="popup" style="height:365px; width:500px;">
    ...
    <div class="popup_cnt">
      ...
      <form name="inquir_form" id="inquir_form" method="post">
        ...
        <tr>
        <td ></td>
        <td ><input type="submit" class="submit_btn" class="form-submit" name="send_invite" value="" id="submit_inq" onclick="return validate_check()" /></td>
        </tr>
      </table>
