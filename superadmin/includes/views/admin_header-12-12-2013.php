...
<div class="nav-outer-repeat">
  ...
  <div class="nav-outer">
    <!-- start nav-right -->
    <div id="nav-right" style="width: 300px;">
    ...
    <div class="nav">
      <div class="table">
        ...
        <ul class="select<?php  if(strpos($_SERVER['REQUEST_URI'],'contact')!==false || strpos($_SERVER['REQUEST_URI'],'users')!==false){?> current<?php } ?>">
          ...
          <div class="select_sub show">
              <ul class="sub">
		<li <?php  if(strpos($_SERVER['REQUEST_URI'],'contact')!==false && strpos($_SERVER['REQUEST_URI'],'index/') !==false  && basename($_SERVER['REQUEST_URI'])=='index.php'){?>class="sub_show"<?php } ?>><a href="<?=DEFAULT_ADMIN_URL?>/contact/index/index.php">Index Page Inquiry</a></li>                
		<li <?php  if(strpos($_SERVER['REQUEST_URI'],'contact')!==false && strpos($_SERVER['REQUEST_URI'],'general') !==false  && basename($_SERVER['REQUEST_URI'])=='index.php'){?>class="sub_show"<?php } ?>><a href="<?=DEFAULT_ADMIN_URL?>/contact/general/index.php">General Inquiry</a></li>
                <li <?php  if(strpos($_SERVER['REQUEST_URI'],'contact')!==false && strpos($_SERVER['REQUEST_URI'],'car') !==false  && basename($_SERVER['REQUEST_URI'])=='index.php'){?>class="sub_show"<?php } ?>><a href="<?=DEFAULT_ADMIN_URL?>/contact/car/index.php">Cars Inquiry</a></li>
                 <li <?php  if(strpos($_SERVER['REQUEST_URI'],'contact')!==false && strpos($_SERVER['REQUEST_URI'],'consult') !==false  && basename($_SERVER['REQUEST_URI'])=='index.php'){?>class="sub_show"<?php } ?>><a href="<?=DEFAULT_ADMIN_URL?>/contact/consult/index.php">Consult Specialist Inquiry</a></li>
