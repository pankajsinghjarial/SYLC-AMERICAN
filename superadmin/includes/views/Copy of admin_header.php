...
<?php $folder_name=end(array_slice(explode('/',$_SERVER['REQUEST_URI']),-2,1));
$pagename=basename(end(array_slice(explode('/',$_SERVER['REQUEST_URI']),-1,1)),'.php');
?>
...
<script type="text/javascript" charset="utf-8">
  $(function() {
      $("input.file_1").filestyle({ 
          image: "<?php echo ADMIN_IMAGE_URL; ?>/forms/choose-file.gif",
          imageheight : 29,
          imagewidth : 78,
          width : 300
      });
...
<div id="page-top-outer">
  ...
  <div id="page-top">
    <!-- start logo -->
    <div id="logo"> <a href=""><img src="<?php echo ADMIN_IMAGE_URL; ?>/shared/logo.png" width="156" height="40" alt="" /></a> </div>
    <!-- end logo -->
    <!--  start top-search -->
    <div id="top-search">
      <table border="0" cellpadding="0" cellspacing="0">
        <tr>
          ...
          <td><input type="image" src="<?php echo ADMIN_IMAGE_URL; ?>/shared/top_search_btn.gif"  />
          </td>
        </tr>
      </table>
    </div>
...
<div class="nav-outer-repeat">
  ...
  <div class="nav-outer">
    ...
    <div id="nav-right">
      ...
      <div class="account-content">
        <div class="account-drop-inner"> <a href="" id="acc-settings">Settings</a>
          ...
          <a href="<?= DEFAULT_ADMIN_URL; ?>/user_setting" id="acc-details">Personal details </a>
          <div class="clear">&nbsp;</div>
          <div class="acc-line">&nbsp;</div>
    ...
    <div class="nav">
		...
		<ul class="select <?php if($folder_name=='home'){?>current<?php } ?>"><li> <a href="<?= DEFAULT_ADMIN_URL; ?>/home/home.php"> <b>Dashboard</b></a><!--[if IE 7]><!--></a><!--<![endif]-->
		...
		<ul class="select <?php  if($folder_name=='page'){?>current<?php } ?>" ><li><a href="#nogo" ><b>Page Manager</b></a><!--[if IE 7]><!--></a><!--<![endif]-->
		<!--[if lte IE 6]><table><tr><td><![endif]-->
		<div class="select_sub show">
			<ul class="sub">
				<li <?php  if($pagename=='index'){?>class="sub_show"<?php } ?>><a href="<?=DEFAULT_ADMIN_URL?>/page/index.php" >View all Pages</a></li>
				<li  ><a href="<?=DEFAULT_ADMIN_URL?>/article/add.php">Add New Page</a></li>
		...
		<ul class="select"><li><a href="#nogo" ><b>Categories</b></a><!--[if IE 7]><!--></a><!--<![endif]-->
		<!--[if lte IE 6]><table><tr><td><![endif]-->
		...
		<ul class="select"><li><a href="#nogo" ><b>Clients</b></a><!--[if IE 7]><!--></a><!--<![endif]-->
		<!--[if lte IE 6]><table><tr><td><![endif]-->
		<div class="select_sub">
			<ul class="sub">
		...
		<ul class="select"><li><a href="#nogo" ><b>News</b></a><!--[if IE 7]><!--></a><!--<![endif]-->
		<!--[if lte IE 6]><table><tr><td><![endif]-->
		<div class="select_sub">
			<ul class="sub">
