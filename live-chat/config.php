...
if($installed==true){
 ...
 $server = 'localhost';
 $database = 'httpsylc_sylc';
 $datausername = 'httpsylc_sylcUse ';
 $password = 'User@123';
 ...
 $application_root = '/home/httpsylc/public_html/live-chat/';
 ...
 $API_HOME_DIR = '/home/httpsylc/public_html/live-chat/' . 'txt-db-api/';
